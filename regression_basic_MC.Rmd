...
Expandido para o plano $\mathbb{R}^d$: 

$$
Y_{i} = \beta_{1} + \beta_{2}X_{i} + \ldots + \beta_{d}X_{i} + \mu_{i}
$$


Observe a adição de $\mu$ representando os resíduos da regressão. Os quais são em essência a diferenças entre os valores observados e estimados. Por sua vez, ${\beta_{1}}$ e ${\beta_{2}}$ representam o intercepto e coeficiente angula da equação da reta, respectivamente. Assim, estima-se dado uma amostra $n$ com variabilidade: 
